...
async def main():
    ...
    try:
        ...
        font = pygame.font.Font(None, 30)  # Fallback to default font
        large_font = pygame.font.Font(None, 60)

    #load images
    try:
        cue_image = pygame.image.load(resource_path("assets/images/cue.png")).convert_alpha()
        table_image = pygame.image.load(resource_path("assets/images/table.png")).convert_alpha()
        ball_images = []
        for i in range(1, 17):
            ball_image = pygame.image.load(resource_path(f"assets/images/ball_{i}.png")).convert_alpha()
    ...
    def draw_text(text, font, text_col, x, y):
        try:
            ...
            pass  # Gestione silenziosa degli errori di rendering
